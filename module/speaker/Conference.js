...
export default () => {
  return (
    <Container>
      <SegmentPageHeader date={CONFERENCE.date} headerTitle={CONFERENCE.title} pageTitle={'Speakers'}/>
      <CardList>
        {renderAuthorCards(mainSpeakers)}
        <AuthorCard name='持續邀請中' description='若遇不可抗拒因素或其他未盡事宜，主辦單位保留活動議程及講師更動之權利。'/>
      </CardList>
    </Container>
  );
};
